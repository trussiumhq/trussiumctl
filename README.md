...
Release archives are accompanied by GitHub artifact attestations generated by
the release workflow. Verify an archive with:

```console
gh attestation verify path/to/downloaded-archive.tar.gz --repo trussiumhq/trussiumctl
```
