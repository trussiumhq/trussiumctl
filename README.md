...
Release checksums are accompanied by GitHub artifact attestations generated by
the release workflow. Verify the downloaded checksum file with:

```console
gh attestation verify path/to/checksums.txt --repo trussiumhq/trussiumctl
```
